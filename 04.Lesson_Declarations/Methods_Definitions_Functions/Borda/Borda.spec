...
definition unRegisteredVoter(address voter) returns bool = !voterRegistered(voter);
definition registeredYetNotVotedVoter(address voter) returns bool = voterRegistered(voter) && !voterVoted(voter);
definition legitRegisteredVotedVoter(address voter) returns bool = voterRegistered(voter) && !voterBlocked(voter);
definition blockedVoter(address voter) returns bool = voterRegistered(voter) && voterBlocked(voter);
