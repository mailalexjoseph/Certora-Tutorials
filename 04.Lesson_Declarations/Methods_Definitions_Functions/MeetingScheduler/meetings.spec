...
// @note definitions for meeting states
        ...
        definition PENDING(uint256 id) returns bool = getStartTimeById(id)>0 && getEndTimeById(id)>getEndTimeById(id) && getNumOfParticipents(id)==0 && getOrganizer(id)!=0 && getStateById(id)==1;
        definition STARTED(env e, uint256 id) returns bool = (getStartTimeById(id) <= e.block.timestamp) && getEndTimeById(id)>getEndTimeById(id) && getNumOfParticipents(id)>=0 && getOrganizer(id)!=0 && getStateById(id)==2;
        definition ENDED(env e, uint256 id) returns bool = getStartTimeById(id)<e.block.timestamp && getEndTimeById(id)<e.block.timestamp && getNumOfParticipents(id)>=0 && getOrganizer(id)!=0 && getStateById(id)==3;
        definition CANCELLED(uint256 id) returns bool = getStartTimeById(id)>0 && getEndTimeById(id)>getEndTimeById(id) && getNumOfParticipents(id)==0 && getOrganizer(id)!=0 && getStateById(id)==4;
